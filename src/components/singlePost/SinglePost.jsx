...
export default function SinglePost() {
  return (
    <div className="singlePost">
       ...
       <p className="singlePostDesc">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora soluta ipsa placeat, perferendis nesciunt iusto deleniti expedita quasi velit libero distinctio blanditiis ipsam praesentium voluptates in temporibus hic eos. Debitis?
